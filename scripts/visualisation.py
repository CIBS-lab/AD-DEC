...
def plot_stability(df_stab, save=False, filetype="png", mutation=1,
                   stability_type="sample", title=None, savename="stability_histogram"):
    ...
    # Save plot without additional path modifications
    if save and savename:
        plt.savefig(savename, format=filetype)
